 ...
 * @Last Modified time: 2020-02-04 21:40:19
 */
  ...
  createMenu() {
    ...
    var option = $(`<div id="toolbar">
        ...
        <div id='drawId' class="menuOption">
          ...
          <label class="option" id="remove" style="position:absolute;right:10px;top:0px;float:right">关闭</label>
          <table>
            <tr>
              <td>
    ...
    var sfleft = $(`<div id='statframleftID' class='sfClass' style="left:0px">
      <table class="sfTable">
        <tr>
          <td>
        ...
        <tr>
          <td>
            <div class="floatdiv" id="salstat"></div>
          </td>
        </tr>
      </table>
      <img class="closetemp" id="closetempId1" src="./data/close.png" width=20px height=20px />
      </div>`);
      var sfright = $(`<div id='statframrightID' class='sfClass' style="right:0px">
      <table class="sfTable">
        <tr>
          <td>
