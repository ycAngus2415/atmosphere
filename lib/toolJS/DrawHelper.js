...
var DrawHelper = (function () {
    ...
    var dragHalfBillboard = {
        iconUrl: "./data/img/dragIconLight.png",
        shiftX: 0,
        shiftY: 0
    }
    ...
    _.DrawHelperWidget = (function () {
        ...
        function _(drawHelper, options) {
            ...
            var drawOptions = {
                markerIcon: "./data/img/glyphicons_242_google_maps.png",
                polylineIcon: "./data/img/glyphicons_097_vector_path_line.png",
                polygonIcon: "./data/img/glyphicons_096_vector_path_polygon.png",
                circleIcon: "./data/img/glyphicons_095_vector_path_circle.png",
                extentIcon: "./data/img/glyphicons_094_vector_path_square.png",
                clearIcon: "./data/img/glyphicons_067_cleaning.png",
