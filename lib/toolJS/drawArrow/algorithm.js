...
xp.algorithm.fineArrow = function (tailPoint, headerPoint) {
    ...
    var e = o[0];
    var r = o[1];
    var n = P.PlotUtils.getBaseLength(o);
    ...
    //头部宽度因子
    var a = P.PlotUtils.getThirdPoint(r, e, P.Constants.HALF_PI, g, !0);
    var l = P.PlotUtils.getThirdPoint(r, e, P.Constants.HALF_PI, g, !1);
    var u = P.PlotUtils.getThirdPoint(e, r, headAngle, s, !1);
    var c = P.PlotUtils.getThirdPoint(e, r, headAngle, s, !0);
    var p = P.PlotUtils.getThirdPoint(e, r, neckAngle, i, !1);
    var h = P.PlotUtils.getThirdPoint(e, r, neckAngle, i, !0);
    var d = [];
    d.push(e[0], e[1], p[0], p[1], u[0], u[1], r[0], r[1], c[0], c[1], h[0], h[1], l[0], l[1], e[0], e[1]);
